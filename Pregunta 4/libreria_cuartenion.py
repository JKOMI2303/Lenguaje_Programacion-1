    ...
    def __mul__(self, other):## overload of *
        ...
        if(type(other)==int):
            return cuaternion(self.r*other-self.i*other-self.j*other-self.k*other,
                              ...
                              self.r*other-self.j*other+self.k*other+self.i*other,
                              self.r*other+self.k*other-self.i*other+self.j*other)
        elif(type(other)==float):
            return cuaternion(self.r*other-self.i*other-self.j*other-self.k*other,
            ...
            return cuaternion(self.r*other.r-self.i*other.i-self.j*other.j-self.k*other.k,
                              ...
                              self.r*other.j-self.j*other.k+self.k*other.r+self.i*other.i,
                              self.r*other.k+self.k*other.j-self.i*other.i+self.j*other.r)
